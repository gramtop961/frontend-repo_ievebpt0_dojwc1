...
export default function Hero3D() {
  return (
    <section id="home" className="relative min-h-[90vh] w-full overflow-hidden bg-[#0a0b10] text-white">
      ...
      <div className="relative mx-auto flex min-h-[90vh] w-full max-w-7xl flex-col justify-center px-6 pointer-events-none">
        <motion.div
          variants={container}
          initial="hidden"
          animate="visible"
          className="max-w-3xl"
        >
          <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 backdrop-blur pointer-events-auto">
